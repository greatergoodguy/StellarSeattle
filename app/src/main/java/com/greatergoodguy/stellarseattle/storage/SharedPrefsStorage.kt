 ...
 */
    fun getFavoriteVenueIds(context: Context): MutableSet<String> {
        val prefs: SharedPreferences =
            context.getSharedPreferences(Key.STELLAR_SEATTLE_SHARED_PREFS, MODE_PRIVATE)
        return (prefs.getStringSet(Key.FAVORITE_VENUE_IDS, mutableSetOf())
    ...
    fun addFavoriteVenue(context: Context, venueId: String) {
        ...
        val editor: SharedPreferences.Editor =
            context.getSharedPreferences(Key.STELLAR_SEATTLE_SHARED_PREFS, MODE_PRIVATE).edit()
